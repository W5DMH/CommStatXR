...
class Ui_MainWindow(QWidget):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.tableWidget_2, 3, 0, 1, 4)
        #self.loadbulletins()
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "CommStatXR 0.06"))
    ...
    def directed(self):
        ...
        #self.text_edit_widget.setParent(None)
        ...
        #QtCore.QTimer.singleShot(60000, self.directed)
