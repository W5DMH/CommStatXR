...
class Ui_FormHeard(object):
    ...
    def retranslateUi(self, FormHeard):
        ...
        FormHeard.setWindowTitle(_translate("FormHeard", "CommStatX Heard List"))
    ...
    def loadheard(self):
        ...
        query = "SELECT date, callsign, gridlat, gridlong FROM heard_Data"
        ...
        table.setHorizontalHeaderLabels(
            str("Date Time UTC ;Callsign; Latitude; Longitude").split(
                ";"))
